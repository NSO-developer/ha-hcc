...
- manager: SSH client to manage the paris nodes
...
5. Connect to the paris1 and paris2 shell to examine the Linux kernel route
   status.
...
manager container for Docker host access through the VIP address uses
